                ...
                <div class="card-body align-items-center text-center">
                    ...
                    <div>
                        ...
                        <div class="mb-3 row g-2 align-items-center">
                            <div class="col">
                                <input type="password" class="form-control col-auto" min="13"name="motDePasse1" placeholder="Mot de passe..." required>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="card mb-3 text-start">
                            <div class="card-body">
                                ...
                                <p>
                                    Les informations recueillies sur ce formulaire sont enregistrées dans un fichier informatisé par <strong>Tony NEUSCH</strong> pour <strong>l'authentification des utilisateurs</strong>. La base légale du traitement est <strong>le consentement</strong>.
                                    <br/><br/>
                                    ...
                                    <br/><br/>
                                    Pour exercer ces droits ou pour toute question sur le traitement de vos données dans ce dispositif, vous pouvez contacter <strong>notre délégué à la protection des données</strong> : <strong>Tony NEUSCH tonynsch@gmail.com</strong>
                                    <br/><br/>
